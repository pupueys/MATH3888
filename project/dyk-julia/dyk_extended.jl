...
# Everything past br is for limit cycles
...
optnewton = NewtonPar(tol = 1e-10, verbose = true, max_iterations = 25)

oopts_br_po = ContinuationPar(plot_every_step = 2, p_min =0., p_max = 60., dsmax=1e-2, ds=1e-3,max_steps = 1000, newton_options = optnewton, detect_bifurcation = 0)
